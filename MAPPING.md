...
| `configmap-reload_v0.5.0` | `harbor.example.com/myproject/configmap_reload:v0.5.0` |
...
| `grafana_12.2.0` | `harbor.example.com/myproject/grafana:12.2.0` |
...
| `kube-state-metrics_v2.5.0` | `harbor.example.com/myproject/kube_state_metrics:v2.5.0` |
...
| `loki_3.5.0` | `harbor.example.com/myproject/loki:3.5.0` |
...
| `otel_0.147.0` | `harbor.example.com/myproject/otel:0.147.0` |
...
| `prometheus_v2.36.2` | `harbor.example.com/myproject/prometheus:v2.36.2` |
...
| `tempo_2.8.2` | `harbor.example.com/myproject/tempo:2.8.2` |
